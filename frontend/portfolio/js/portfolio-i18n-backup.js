    ...
    constructor() {
        ...
        this.translations = {
            fr: {
                // Navigation
                nav: {
                    brand: "ZineInsight",                    testimonial2: {
            ...
            en: {
                ...
                testimonials: {
                    badge: "💬 Testimonials",
                    title: "What SME executives say",
                    subtitle: "Concrete results and measurable time savings with Power BI dashboards",
                    testimonial1: {
                        text: "Our real-time sales tracking saved us 2 days per month on reports. We can see everything at a glance now.",
                        name: "Patrick D.",
                        role: "SARL Manager - Construction",
                        impact: "Sales tracking"
                    },
                    testimonial2: {
                        text: "No more endless Excel spreadsheets. Our sales team sees their targets and results with a simple click. 2-hour training was perfect.",
                        name: "Marie L.",
                        role: "Director - B2B Services",
                        impact: "Team tracking"
                    }
                ...
                technology: {
                    ...
                    advantage2: {
                        ...
                        description: "Ultra-fast calculation engine, automatic refresh, handling millions of rows without problems.",
                    ...
                    advantage3: {
                        ...
                        description: "Over 200 native connectors: SQL, Excel, REST APIs, Google Analytics, Salesforce, BigQuery...",
                        feature1: "BigQuery, PostgreSQL, MySQL",
                    ...
                    advantage4: {
                        ...
                        feature2: "Secure sharing via links",
                        feature3: "Push alerts on mobile"
                    }
                },
